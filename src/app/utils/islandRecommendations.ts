...
const ISLAND_PROFILES = {
  ...
  socheong: {
    ...
    name: "소청도",
    image: "https://images.unsplash.com/photo-1661488601431-e8257e864068?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 9, 액티비티: 5, 맛집탐방: 2, 자연관광: 9, 반려동물동반: 4 },
    features: ["분바위", "등대", "해안절벽"],
    reason: "분바위와 등대가 있는 작고 아름다운 섬",
  },
  yeonpyeong: {
    id: "yeonpyeong",
    name: "연평도",
    image: "https://images.unsplash.com/photo-1628412071389-6e8f7a7a4e6e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 6, 액티비티: 7, 맛집탐방: 7, 자연관광: 6, 반려동물동반: 5 },
    features: ["조기잡이", "낚시 명소", "해안산책"],
    reason: "조기잡이로 유명한 서해 5도의 어촌",
  },
  seungbong: {
    id: "seungbong",
    name: "승봉도",
    image: "https://images.unsplash.com/photo-1635355942488-a8bdb5a0803e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 8, 액티비티: 6, 맛집탐방: 5, 자연관광: 7, 반려동물동반: 7 },
    features: ["해안산책로", "조용한 마을", "선착장"],
    reason: "작고 아담한 섬의 조용한 매력",
  },
  daeijak: {
    id: "daeijak",
    name: "대이작도",
    image: "https://images.unsplash.com/photo-1661488601431-e8257e864068?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 8, 액티비티: 8, 맛집탐방: 5, 자연관광: 9, 반려동물동반: 6 },
    features: ["목기미해변", "부아산 트레킹", "청정 해역"],
    reason: "청정 해역과 트레킹을 즐기는 섬",
  },
  soijak: {
    id: "soijak",
    name: "소이작도",
    image: "https://images.unsplash.com/photo-1662898069390-badabf2d65df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 9, 액티비티: 5, 맛집탐방: 4, 자연관광: 7, 반려동물동반: 7 },
    features: ["해수욕장", "조개잡이", "한적한 분위기"],
    reason: "한적한 해변에서 여유를 즐기는 섬",
  },
  pungdo: {
    id: "pungdo",
    name: "풍도",
    image: "https://images.unsplash.com/photo-1700621496615-6ee6240503ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 8, 액티비티: 6, 맛집탐방: 4, 자연관광: 9, 반려동물동반: 6 },
    features: ["동백나무숲", "해안트레킹", "일몰 명소"],
    reason: "봄이면 동백꽃이 피어나는 섬",
  },
  yukdo: {
    id: "yukdo",
    name: "육도",
    image: "https://images.unsplash.com/photo-1758327740342-4e705edea29b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 10, 액티비티: 3, 맛집탐방: 1, 자연관광: 8, 반려동물동반: 6 },
    features: ["갯벌 체험", "작은 어촌마을", "한적함"],
    reason: "주민 30여 명이 사는 작고 평화로운 섬",
  },
  sindo: {
    id: "sindo",
    name: "신도",
    ...
    reason: "삼목항에서 배로 10분, 접근성 좋은 관문 섬",
  },
  sido: {
    id: "sido",
    name: "시도",
    image: "https://images.unsplash.com/photo-1700621496615-6ee6240503ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 7, 액티비티: 5, 맛집탐방: 4, 자연관광: 6, 반려동물동반: 7 },
    features: ["수기해변", "신도 연도교 연결", "조용한 섬"],
    reason: "신도와 다리로 연결된 조용한 섬",
  },
  jangbongdo: {
    id: "jangbongdo",
    name: "장봉도",
    image: "https://images.unsplash.com/photo-1635355942488-a8bdb5a0803e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 8, 액티비티: 7, 맛집탐방: 5, 자연관광: 8, 반려동물동반: 7 },
    features: ["옹암해변", "진촌해변", "한들해수욕장"],
    reason: "해변이 여럿인 트레킹하기 좋은 섬",
  },
  soya: {
    id: "soya",
    name: "소야도",
    image: "https://images.unsplash.com/photo-1662898069390-badabf2d65df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 8, 액티비티: 6, 맛집탐방: 5, 자연관광: 7, 반려동물동반: 7 },
    features: ["떼뿌리 해변", "덕적도 연도교 연결", "한적함"],
    reason: "덕적도와 다리로 이어진 한적한 섬",
  },
  uldo: {
    id: "uldo",
    name: "울도",
    image: "https://images.unsplash.com/photo-1661488601431-e8257e864068?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    styles: { 힐링: 9, 액티비티: 4, 맛집탐방: 2, 자연관광: 7, 반려동물동반: 6 },
    features: ["덕적도 환승 접근", "작고 조용한 섬", "등대 조망"],
    reason: "덕적도에서 환승해 가는 작고 조용한 섬",
  },
  // modo, mungap, baegado: 관광공사 API에 실데이터가 없고 조사된 정보도 부족해 추천 프로필 미작성
};
